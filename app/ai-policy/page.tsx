...
export const metadata: Metadata = { title: "Technology Use Policy", description: "How Aura Digital Intelligence uses technology while protecting editorial quality.", alternates: { canonical: `${siteUrl()}/ai-policy` } };
export default function Page() { return <EditorialPage eyebrow="Editorial transparency" title="Technology use policy." intro="Aura Digital Intelligence uses software-assisted workflows and selected AI tools under published evidence and editorial standards.">

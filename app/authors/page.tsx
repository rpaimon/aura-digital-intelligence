...
export default function AuthorsPage() {
  return (
    <main className="min-h-screen bg-[#070707] text-white">
      <NewsHeader />
      <section className="adi-noise border-b border-white/10"><div className="mx-auto max-w-[1480px] px-4 py-12 sm:px-6 lg:px-8 lg:py-16"><p className="text-[10px] font-black uppercase tracking-[0.2em] text-white/35">The publication desk behind Aura Intelligence</p><h1 className="mt-3 text-6xl font-black uppercase leading-[.85] tracking-[-0.07em] sm:text-8xl lg:text-[8rem]">Authors</h1></div></section>
